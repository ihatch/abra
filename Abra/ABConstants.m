...
CGFloat const ABRA_FONT_SIZE = 21.0;
CGFloat const ABRA_FONT_MARGIN = 8.0;
CGFloat const ABRA_LINE_HEIGHT = 44;

NSString *const ABRA_FLOWERBED_FONT = @"IM FELL FLOWERS 1";
CGFloat const ABRA_FLOWERBED_FONT_SIZE = 28;
NSString *const ABRA_FLOWERS_FONT = @"IM FELL FLOWERS 2";
CGFloat const ABRA_FLOWERS_FONT_SIZE = 30;
