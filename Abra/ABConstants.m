...
CGFloat const ABRA_NORMAL_SPEED = 0.9;
CGFloat const ABRA_SLOWEST_SPEED = 1.4;
CGFloat const ABRA_FASTEST_SPEED = 0.18;
...
CGFloat const ABRA_BASE_STANZA_TIME = 8.7;
CGFloat const ABRA_WORD_ANIMATION_SPEED = 1100;
CGFloat const ABRA_WORD_FADE_OUT_DURATION = 350;
