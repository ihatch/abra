...
NSString *const NON_ASCII_REGEX = @"[^\\u0000-\\u007F]";
NSString *const NUMBERS_REGEX = @"(?<!\\S)(?=.)(0|([1-9](\\d*|\\d{0,2}(,\\d{3})*)))?(\\.\\d*[1-9])?(?!\\S)";
